...
static uint8_t CC2500_SendByte(uint8_t );
uint8_t CC2500_read_one(uint8_t );
void CC2500_write_one(uint8_t* , uint8_t );
...
void CC2500_read_rx(uint8_t* , uint8_t );
void CC2500_write_tx_one(uint8_t );
void CC2500_write_tx(uint8_t* , uint8_t );
